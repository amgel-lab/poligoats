...
Este proyecto consiste en la construcción y programación de un **carrito omnidireccional** controlado por una **Raspberry Pi 4.** Gracias a las ruedas mecanum/omnidireccionales, el vehículo puede desplazarse en **cualquier dirección** sin necesidad de girar.
El control del movimiento se realiza mediante un **mando inalámbrico de PlayStation 4 (DualShock 4)** conectado a la Raspberry Pi vía Bluetooth.
